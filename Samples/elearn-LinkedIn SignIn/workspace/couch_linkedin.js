...
(function($) {
  ...
  $.extend($.couch, {
    ...
    activeTasks: function(options) {
      ajax(
        {url: "https://jeez07z.cloudant.com" + "/_active_tasks"},
        options,
    ...
    allDbs: function(options) {
      ajax(
        {url: "https://jeez07z.cloudant.com" + "/_all_dbs"},
        options,
    ...
    config: function(options, section, option, value) {
      var req = {url: "https://jeez07z.cloudant.com" + "/_config/"};
      if (section) {
    ...
    session: function(options) {
      options = options || {};
      $.ajax({
        type: "GET", url: "https://jeez07z.cloudant.com" + "/_session",
    ...
    login: function(options) {
      options = options || {};
      $.ajax({
        type: "POST", url: "https://jeez07z.cloudant.com" + "/_session", dataType: "json",
        data: {name:jeez07z, password: Suj224637},
        beforeSend: function(xhr) {
            xhr.setRequestHeader('Accept', 'application/json');
        },
        complete: function(req) {
    ...
    logout: function(options) {
      options = options || {};
      $.ajax({
        type: "DELETE", url: "https://jeez07z.cloudant.com" + "/_session", dataType: "json",
    ...
    db: function(name, db_opts) {
      ...
      return /** @lends $.couch.db */{
        name: name,
        uri: "https://jeez07z.cloudant.com" + "/" + encodeURIComponent(name) + "/",
    ...
    info: function(options) {
      ajax(
        {url: "https://jeez07z.cloudant.com" + "/"},
        options,
    ...
    replicate: function(source, target, ajaxOptions, repOpts) {
      ...
      ajax({
          type: "POST", url: "https://jeez07z.cloudant.com" + "/_replicate",
    ...
    newUUID: function(cacheNum) {
      ...
      if (!uuidCache.length) {
        ajax({url: "https://jeez07z.cloudant.com" + "/_uuids", data: {count: cacheNum}, async:
              false}, {
            success: function(resp) {
